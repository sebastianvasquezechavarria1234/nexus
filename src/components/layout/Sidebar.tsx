    ...
    <aside className="w-[280px] bg-[#0a0a0c] flex flex-col h-screen fixed left-0 top-0 z-[50] overflow-y-auto border-r border-white/5">
      <div className="p-8">
        ...
        <div className="flex bg-[#16161a] p-1 rounded-[14px] mb-8">
          <button className="flex-1 py-2 text-[11px] font-bold bg-[#27272a] text-white rounded-[10px] shadow-sm transition-all">Staking</button>
          <button className="flex-1 py-2 text-[11px] font-bold text-white/30 hover:text-white/50 transition-colors">Stablecoin</button>
        </div>
